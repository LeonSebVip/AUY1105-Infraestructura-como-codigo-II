module "vpc" {
  source                = "github.com/LeonSebVip/AUY1105-Infraestructura-como-codigo-II//EA2/ACT2.5/vpc_module?ref=1.0.0"
...
module "ec2" {
  source        = "github.com/LeonSebVip/AUY1105-Infraestructura-como-codigo-II//EA2/ACT2.5/ec2_module?ref=1.0.0"
